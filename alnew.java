...
import java.util.*;
class collect{
	public static void sortmergedarraylist(ArrayList <Integer> a1,ArrayList <Integer> a2){
		System.out.println("Merged array list is "+a1);
		a1.addAll(a2);
		System.out.println("Sorted array list is "+a1);
		Collections.sort(a1);
		for(Integer st:a1){
			System.out.print(" "+st);
		}
